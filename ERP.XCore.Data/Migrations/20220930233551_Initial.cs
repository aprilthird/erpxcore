        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionLevelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Permissions_PermissionLevels_PermissionLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyHeadquarters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyHeadquarters_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyHeadquarters_Status_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Status",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkPositionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TicketPrinter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyHeadquarterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PointsOfSale_CompanyHeadquarters_CompanyHeadquarterId",
                        column: x => x.CompanyHeadquarterId,
                        principalTable: "CompanyHeadquarters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PointsOfSale_Status_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Status",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyHeadquarters_CompanyId",
                table: "CompanyHeadquarters",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyHeadquarters_StatusId",
                table: "CompanyHeadquarters",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_PermissionLevelId",
                table: "Permissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointsOfSale_CompanyHeadquarterId",
                table: "PointsOfSale",
                column: "CompanyHeadquarterId");

            migrationBuilder.CreateIndex(
                name: "IX_PointsOfSale_StatusId",
                table: "PointsOfSale",
                column: "StatusId");
